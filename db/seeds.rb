...
Annonce.create(title:"Vélo", content:"Superbe velo, presque neuf", user:User.find_by_email('user@mail.com'), categories:Category.find_by_name("Loisir"), price:"65")
Annonce.create(title:"Moto", content:"Superbe moto, presque neuf, 1000 km", user:User.find_by_email('user1@mail.com'), categories:Category.find_by_name("Véhicule"), price:"4500")
Annonce.create(title:"PS3", content:"Superbe PS3, presque neuf, 3 jeux", user:User.find_by_email('user1@mail.com'), categories:Category.find_by_name("Multimédia"), price:"150")
